...
TEST_CONFIG = {
    ...
    'invalid_device_ids': ['', 'ab', 'toolongdevice', 'test-with-dash', 'test_with_underscore'],
    'test_urls': [
...
class TestDataGenerator:
    ...
    @staticmethod
    def generate_heartbeat_sequence(device_id: str, count: int, 
                                   base_hr: int = 70, variation: int = 30) -> List[str]:
